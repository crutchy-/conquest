...
begin
  ...
  P1 := ConvertNodeToPixelCoord(Round(FMouseDownCoordX / FSnapDistance) * FSnapDistance, Round(FMouseDownCoordY / FSnapDistance) * FSnapDistance);
  FImageBuffer.Canvas.Ellipse(P1.X - 5, P1.Y - 5, P1.X + 6, P1.Y + 6);
...
begin
  ...
  begin
    i := Round(FMouseDownCoordX);
    j := Round(FMouseDownCoordX);
